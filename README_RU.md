...
- [x] Настраиваемые параметры для включения/отключения функций.
- [x] Режим отладки для тестирования и проверки функционала.
- [x] Начисление опыта за разные виды активности (PvP, убийство боссов, выполнение заданий).
- [x] Еженедельный лимит на количество опыта для баланса прокачки гильдий.
- [x] Оповещение в гильдейский чат о повышении уровня гильдии.
- [x] Команда для игрока чтобы отобразить информацию о гильдии `.ginfo`
